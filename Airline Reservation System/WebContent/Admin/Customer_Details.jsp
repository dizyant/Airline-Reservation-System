                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Customer_Details</h4>
                        ...
                        <div class="row">
							...
							<div class="col-lg-12">
								<div class="card-box">
									...
									<form action="insertCustomer.jsp" method="post" class="form-horizontal" role="form"  data-parsley-validate novalidate>
										<input type="hidden" name="flag" value="insert"/>
										
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-4 control-label">Customer_Name</label>
											<div class="col-sm-7">
												<input type="text" name="custname"  required class="form-control" id="inputEmail3"/> 
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-4 control-label">Title</label>
											<div class="col-sm-7">
												<select name="title" class="form-control select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" value="Type or Select from List"/>
													<option value=""></option>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="password" required name="pass" class="form-control" id="hori-pass2" placeholder="dd-mm-yyyy"/>
											</div>
										</div>
