...
ResultSet rs = s.executeQuery("SELECT * FROM flights WHERE id='"+s1+"'");
while(rs.next()){
session.setAttribute("fname",rs.getString("flight_name"));
session.setAttribute("source",rs.getString("source"));
session.setAttribute("destination",rs.getString("destination"));
session.setAttribute("charge",rs.getString("charge"));
}
%>
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="card card-signup" style="margin-top: 120px;">
								<form class="form" action="login2.jsp" >
									<div class="header header-primary text-center" style="text-align: center;">
										...
										<h4 style="width: 70%; margin-left:30%; padding-right: 80px;" >FLIGHTS</h4>
									</div>
									...
									<div class="footer text-left" style="float: left;">
										<a href="signup1.jsp" class="btn btn-simple btn-primary btn-lg">SignUp</a>
									</div>
									<div class="text-right">
										<input type="submit" value="LogIn" class="btn btn-simple btn-primary btn-lg"/>
									</div>
