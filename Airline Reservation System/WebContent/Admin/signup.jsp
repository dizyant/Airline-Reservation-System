...
<head>
	...
	<meta charset="utf-8" />
	<link rel="apple-touch-icon" sizes="76x76" href="bs/bs/bs/assets/img/1.jpg">
	<link rel="icon" type="image/png" href="bs/bs/bs/assets/img/1.jpg">
	...
	<!-- CSS Files -->
    <link href="bs/bs/bs/assets/css/bootstrap.min.css" rel="stylesheet" />
    <link href="bs/bs/bs/assets/css/material-kit.css" rel="stylesheet"/>
...
<body>
	    	...
	    	<a href="try1.html">
	        	<div class="logo-container">
	                <div style="opacity:1; background: none;">
	                    <img src="bs/bs/assets/img/ICONCRAZE-COM-Airplane-Icon-PNG-1-512x512.png" height="70px" width="70px" alt="Airlife" rel="tooltip" title="Airline Reservation System" data-placement="bottom" data-html="true">
	...
	<div class="wrapper">
			...
			<div class="section section-full-screen section-signup" style="background-image: url('bs/bs/assets/img/article-0-19A65FB300000578-639_964x656.jpg'); background-size: cover; background-position: top center; min-height: 834px;">
				<div class="container">
					<div class="row">
							...
							<form class="form" method="" action="" >
								...
								<div class="content">
									...
									<div class="input-group">
										...
										<select style="color: #a6a6a6" class="form-control">
									...
									<div class="input-group">
										...
										<input type="numeric" class="form-control" placeholder="Phone No...">
									</div>
...
<script src="bs/assets/js/jquery.min.js" type="text/javascript"></script>
	<script src="bs/assets/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="bs/assets/js/material.min.js"></script>

	<!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
	<script src="bs/assets/js/nouislider.min.js" type="text/javascript"></script>

	<!--  Plugin for the Datepicker, full documentation here: http://www.eyecon.ro/bootstrap-datepicker/ -->
	<script src="bs/assets/js/bootstrap-datepicker.js" type="text/javascript"></script>

	<!-- Control Center for Material Kit: activating the ripples, parallax effects, scripts from the example pages etc -->
	<script src="bs/assets/js/material-kit.js" type="text/javascript"></script>
</html>