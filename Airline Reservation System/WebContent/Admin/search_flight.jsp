                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
								...
								<tr>
									<td><% int i1=r.getInt("id");
										out.print(i1);%></th>
									<td><% String s1=r.getString("flight_name");
										out.print(s1);%></td>
									<td><% String s2=r.getString("source");
										out.print(s2);%></td>
									<td><% String s3=r.getString("destination");
										out.print(s3);%></td>
									<td><% String i2 = r.getString("dep");
										out.print(i2);%></td>
									<td><% String s4 = r.getString("ret");
										out.print(s4);%></td>
									<td><% String s5 = r.getString("charge");
										out.print(s5);%></td>
									<td><a href="editFlight.jsp?id=<%=i1%>">EDIT</a></td> 
									<td><a href="insertFlight.jsp?id=<%=i1%>&flag="<%=s7 %>"">DELETE</a></td>										
								<% 	}%>
								</tr>
