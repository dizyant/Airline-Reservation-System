					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="card card-signup" style="margin-top: 120px;">
								<form class="form" action="cheque2.jsp" >
									...
									<div class="content">
										<div class="input-group">
											...
											<input type="text" name="tkt" value=<%=s1 %> class="form-control" >
										</div>
										...
										<div class="input-group">
											...
											<input type="numeric" name="cn" placeholder="Cheque number..." class="form-control" />
										</div>
										...
										<div class="input-group">
											...
											<input type="date" name="cdate" placeholder="Cheque Date..." class="form-control" />
										</div>
										...
										<div class="input-group">
											...
											<input type="text" name="banme" placeholder="Bank name..." class="form-control" />
										</div>
