            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Search_Flight</h4>
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
										...
										%>
								<tr>
									<td><% int i1=r.getInt("id");
										out.print(i1);%></td>
									<td><% String s1=r.getString("source");
										out.print(s1);%></td>
									<td><% String s2=r.getString("destination");
										out.print(s2);%></td>
									<td><% String s3 = r.getString("ticket_no");
										out.print(s3);%></td>
									<td><% String s4 = r.getString("cust_name");
										out.print(s4);%></td>
									<td><% String s5 = r.getString("gender");
										out.print(s5);%></td>
									<td><% String s6 = r.getString("dob");
										out.print(s6);%></td>
									<td><% String s7 = r.getString("phone_no");
										out.print(s7);%></td>
									<td><% String s8 = r.getString("address");
										out.print(s8);%></td>
							   	    <td><% String s9 = r.getString("dep");
										out.print(s9);%></td>
									<td><% String s10 = r.getString("ret");
										out.print(s10);%></td>
									<td><% String s11 = r.getString("seat_no");
										out.print(s11);%></td>	
									<td><a href="editTicket.jsp?id=<%=i1%>">EDIT</a></td> 
									<td><a href="makeReservation.jsp?id=<%=i1%>&flag=<%=s12%>">DELETE</a></td>										
								<% 	}%>
								</tr>
