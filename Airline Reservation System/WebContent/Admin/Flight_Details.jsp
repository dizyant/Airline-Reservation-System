								...
								<div class="card-box">
									...
									<form class="form-horizontal" role="form" action="insertFlight.jsp" data-parsley-validate novalidate>
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="text" name="fliname" class="form-control" id="inputEmail3" >
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="date" name="departdate" class="form-control" id="inputEmail3"/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="date" name="returndate" class="form-control" id="inputEmail3"/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="numeric" name="flicharge" class="form-control" id="inputEmail3" >
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-4 control-label">Seats</label>
											<div class="col-sm-7">
												<input type="number" name="seat" min="0" class="form-control" id="inputEmail3" >
											</div>
										</div>
