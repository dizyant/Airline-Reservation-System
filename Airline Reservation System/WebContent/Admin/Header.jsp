<div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="icon-magnet icon-c-logo"></i> 
                        
                        <!--  <span>Ub<i class="md md-album"></i>ld</span></a>-->
                        <!-- Image Logo here -->
                        <!--<a href="index.html" class="logo">-->
                            <!--<i class="icon-c-logo"> <img src="images/logo_sm.png" height="42"/> </i>-->
                            <!--<span><img src="images/logo_light.png" height="20"/></span>-->
                        <!--</a>-->
                    </div>
                </div>
